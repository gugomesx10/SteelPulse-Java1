...
public class JdbcPacienteRepository implements PacienteRepository {
    ...
    public Paciente criarUsuario(String nome, String email, String senha, boolean funcionario) {
        ...
        try{
            ...
            preparedStatement.setString(4, funcionario ? "Y" : "N");
            ...
            connection.commit();
            return new Paciente(usuarioId, nome, email, senha);
    ...
    @Override
    public Paciente alterarSenha(String senha) {
        return null;
    }
    ...
    @Override
    public Paciente alterarNome(int id, String novoNome) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
    ...
    @Override
    public List<Paciente> listarUsuarios() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                pacientes.add(new Paciente(id, nome, email, senha));
            }
    ...
    @Override
    public Paciente getUsuarioByEmail(String email) {
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
