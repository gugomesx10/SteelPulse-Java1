...
public interface ContratoRepository {
    ...
    Contrato editar(Contrato contrato) throws EntidadeNaoLocalizada;

    List<Contrato> buscarPorPacienteCpf(String cpf);

    Contrato buscarAtivoPorPacienteCpf(String cpf) throws EntidadeNaoLocalizada;

    List<Contrato> buscarPorClienteCpf(String cpf);

    Contrato buscarAtivoPorClienteCpf(String cpf);

    void finalizar(Long id, Long version) throws EntidadeNaoLocalizada;
}
